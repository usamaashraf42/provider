	...
	<div class="kt-subheader  kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			<div class="kt-subheader__main">
				<h3 class="kt-subheader__title">Header Dark</h3>
										...
										<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
											...
											<div class="kt-timeline-v2__item">
												...
												<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
													<a href="#"><img src="{{url('/')}}/assets/media/users/100_4.jpg" title=""></a>
													<a href="#"><img src="{{url('/')}}/assets/media/users/100_13.jpg" title=""></a>
													<a href="#"><img src="{{url('/')}}/assets/media/users/100_11.jpg" title=""></a>
													<a href="#"><img src="{{url('/')}}/assets/media/users/100_14.jpg" title=""></a>
												</div>
											</div>
											<div class="kt-timeline-v2__item">
										...
										<div class="kt-widget4__items kt-widget4__items--bottom kt-portlet__space-x kt-margin-b-20">
											<div class="kt-widget4__item">
												<div class="kt-widget4__img kt-widget4__img--logo">
													<img src="{{url('/')}}/assets/media/client-logos/logo3.png" alt="">
												</div>
											...
											<div class="kt-widget4__item">
												<div class="kt-widget4__img kt-widget4__img--logo">
													<img src="{{url('/')}}/assets/media/client-logos/logo1.png" alt="">
												</div>
												<div class="kt-widget4__info">
													<a href="#" class="kt-widget4__title">
														FlyThemes
											...
											<div class="kt-widget4__item">
												<div class="kt-widget4__img kt-widget4__img--logo">
													<img src="{{url('/')}}/assets/media/client-logos/logo2.png" alt="">
												</div>
												<div class="kt-widget4__info">
													<a href="#" class="kt-widget4__title">
														AirApp
